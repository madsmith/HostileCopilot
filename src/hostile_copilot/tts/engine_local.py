...
class TTSEngineLocal(TTSEngine):
    def __init__(self, config: OmegaConfig):
        self._model_id: str = config.get("tts-local.model_id") or DEFAULT_MODEL
        self._lang_code: str = config.get("tts-local.lang_code") or "en-US"

        self._voices: list[str] = config.get("tts-local.voices") or []
